...
export const adminSessionRepository = {
  ...
  create: (data: CreateAdminSessionInput) =>
  ...
  findByIdAndAdmin: (id: string, adminId: string) =>
    prisma.adminSession.findFirst({ where: { id, adminId } }),
  ...
  delete: (id: string) => prisma.adminSession.delete({ where: { id } }),
  ...
  deleteAllByAdmin: (adminId: string) =>
