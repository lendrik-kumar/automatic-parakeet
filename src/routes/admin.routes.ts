...
import {
  ...
  adminBulkToggleFeatured,
  adminBulkToggleNewArrival,
  adminBulkUpdateProductPrices,
...
import {
  ...
  bulkCreateTaxRules,
  testTaxRule,
} from "../controllers/tax-rule.controller.js";
import {
  createShippingRule,
  listShippingRules,
  getShippingRule,
  ...
  testShippingRule,
} from "../controllers/shipping-rule.controller.js";
import {
  adminListReturns,
  adminGetReturn,
  adminBulkApproveReturns,
  adminUpdateReturn,
  adminReturnAnalytics,
  adminBulkProcessReturns,
  adminExportReturns,
