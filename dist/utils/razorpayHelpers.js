 ...
 */
export const convertFromSmallestUnit = (amount, currency) => {
    const config = CURRENCY_CONFIGS[currency];
 ...
 */
export const verifyPaymentSignature = (data, secret) => {
    try {
 ...
 */
export const generateOrderReceipt = (orderNumber) => {
 ...
 */
export const isPaymentMethodOnline = (paymentMethod) => {
 ...
 */
export const mapPaymentMethodToRazorpay = (paymentMethod) => {
    const mapping = {
        CREDIT_CARD: "card",
        DEBIT_CARD: "card",
 ...
 */
export const mapRazorpayMethodToInternal = (razorpayMethod) => {
    const mapping = {
 ...
 */
export const parseRazorpayError = (error) => {
 ...
 */
export const getRazorpayErrorCode = (error) => {
    if (typeof error === "object" && error !== null) {
        const err = error;
 ...
 */
export const isValidRazorpayOrderId = (orderId) => {
 ...
 * @returns True if valid
 */
export const isValidRazorpayPaymentId = (paymentId) => {
 ...
 * @returns Formatted amount string
 */
export const formatAmountFromSmallestUnit = (amountInSmallestUnit, currency) => {
