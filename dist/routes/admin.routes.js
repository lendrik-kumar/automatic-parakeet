...
import { adminCreateProduct, adminListProducts, adminGetProduct, adminUpdateProduct, adminDeleteProduct, adminUpdateProductStatus, adminCreateVariant, adminUpdateVariant, adminDeleteVariant, adminAddImages, adminDeleteImage, adminUpdateSpecification, adminCreateSizeGuide, adminDeleteSizeGuide, } from "../controllers/product.controller.js";
import { listInventory, getInventory, updateInventory, } from "../controllers/inventory.controller.js";
import { adminListOrders, adminGetOrder, adminUpdateOrderStatus, } from "../controllers/order.controller.js";
import { createMethod, listMethods, updateMethod, deleteMethod, createShipment, updateShipmentStatus, } from "../controllers/shipping.controller.js";
import { createCoupon, listCoupons, updateCoupon, deleteCoupon, } from "../controllers/coupon.controller.js";
import { adminListReturns, adminUpdateReturn, } from "../controllers/return.controller.js";
import { createRefund, updateRefundStatus, listRefunds, } from "../controllers/refund.controller.js";
import { adminDeleteReview } from "../controllers/review.controller.js";
import { listUsers, getUser, updateUserStatus, } from "../controllers/user-management.controller.js";
import { listAdmins, createAdmin, updateAdmin, updateAdminStatus, } from "../controllers/admin-management.controller.js";
import { listActivityLogs } from "../controllers/activity-log.controller.js";
import { dashboard, salesAnalytics, productAnalytics, } from "../controllers/analytics.controller.js";
