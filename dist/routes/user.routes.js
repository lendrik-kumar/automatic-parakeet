...
import { initiatePhoneRegistration, resendPhoneRegistrationOTP, verifyPhoneOTP, initiateEmailVerification, verifyEmailToken, resendEmailVerification, completeRegistration, requestLoginOTP, resendLoginOTP, loginWithPhone, loginWithEmail, logout, logoutAll, refreshAccessToken, listSessions, revokeSession, forgotPassword, validatePasswordResetToken, resetPassword, getCurrentUser, updateUserProfile, } from "../controllers/user.controller.js";
...
userRouter.post("/auth/register/initiate-email", otpLimiter, initiateEmailVerification);
userRouter.post("/auth/register/resend-email", otpLimiter, resendEmailVerification);
