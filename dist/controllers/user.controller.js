...
export const initiatePhoneRegistration = async (req, res, next) => {
    try {
...
export const resendPhoneRegistrationOTP = async (req, res, next) => {
    try {
...
export const initiateEmailVerificationOTP = async (req, res, next) => {
    try {
...
export const verifyEmailOTPHandler = async (req, res, next) => {
    try {
...
export const resendEmailOTPHandler = async (req, res, next) => {
    try {
        const { sessionId, email, firstName } = initiateEmailOTPSchema.parse(req.body);
