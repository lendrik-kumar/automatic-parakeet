...
export const listShippingRules = async (req, res, next) => {
    try {
...
export const getShippingRule = async (req, res, next) => {
    try {
...
export const updateShippingRule = async (req, res, next) => {
    try {
        ...
        const shippingRule = await svc.updateShippingRule(req.admin.id, req.params.shippingRuleId, data);
        res.status(200).json({
            success: true,
...
export const bulkCreateShippingRules = async (req, res, next) => {
    try {
...
export const testShippingRule = async (req, res, next) => {
    try {
